...
def execute(ctrl, perception, speaker=None, navigator=None):
    ...
    # TODO: Visual mode is disabled for now, using blind geometry sweep only
    # Uncomment when RGB and visual detection are ready
    ...
    print("[Seg2] Using blind geometry sweep mode")
    print("[Seg2] Warning: without RGB, orange/blue balls cannot be distinguished")
